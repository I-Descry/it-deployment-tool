...
- [ ] Not yet re-verified on the actual device that hit this in the first place -- the fix should make Chrome (and every other winget app) install correctly there now, but that hasn't been confirmed since the fix.
